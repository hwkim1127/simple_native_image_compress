...
class ImageCompress {
  const ImageCompress();
  @Deprecated(
      'will be deprecated from 4.0.0. please use `containFromFilepath` instead')
  ...
  static Future<Uint8List> containFromFilepath(
      ...
      NativeImageCompress.instance.api
          .crateApiCompressImageCompressContainFromFilepath(
              ...
              speed: speed);
  @Deprecated(
      'will be deprecated from 4.0.0. please use `fitHeightFromFilepath` instead')
  ...
  static Future<Uint8List> fitHeightFromFilepath(
      ...
      NativeImageCompress.instance.api
          .crateApiCompressImageCompressFitHeightFromFilepath(
              ...
              speed: speed);
  @Deprecated(
      'will be deprecated from 4.0.0. please use `fitWidthFromFilepath` instead')
